 ...
 * 
 */
@WebServiceClient(name = "ProductServiceService", targetNamespace = "http://service.webservice.vp.com", wsdlLocation = "http://localhost:8080/SoapService/services/ProductService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PRODUCTSERVICESERVICE_QNAME = new QName("http://service.webservice.vp.com", "ProductServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/SoapService/services/ProductService?wsdl");
     ...
     */
    @WebEndpoint(name = "ProductService")
    public ProductService getProductService() {
        return super.getPort(new QName("http://service.webservice.vp.com", "ProductService"), ProductService.class);
    }
     ...
     */
    @WebEndpoint(name = "ProductService")
    public ProductService getProductService(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.webservice.vp.com", "ProductService"), ProductService.class, features);
    }
